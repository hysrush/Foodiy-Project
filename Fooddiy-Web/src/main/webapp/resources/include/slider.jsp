...
<div role="main" class="main">
	<div class="container">
		<div class="row">
			<div class="col-xs-6 col-md-3" style="margin:5px 0px">
					<div style="border: 1px solid #48BAE4; text-align:center; padding:5px;">공지사항&nbsp;
					...
					<div style="border: 1px solid #48BAE4; text-align:center; margin: 5px 0px; padding:5px;">신 메뉴 출시!
					<div>
						<%-- 
						<c:forEach items="${ new }">
					...
					<div style="border: 1px solid #48BAE4; text-align: center; padding:5px;">광고
						<%-- 

			...
			<div class="header-column">
				...
				<div class="header-row">
					<div class="header-nav header-nav-stripe">
						...
						<button class="btn header-btn-collapse-nav" data-toggle="collapse" data-target=".cartmain" style="background-color: gray;">
						...
						<div class = "cart-main collapse" style="background-color: red;">

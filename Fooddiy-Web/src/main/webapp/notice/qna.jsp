		...
		<div class="body">
			...
			<div role="main" class="main">
				...
				<div class="container">
					...
					<h2>고객센터 > <strong>자주묻는 질문</strong></h2>

					<section class="section section-default">
						<div class="container">
							<div class="row">
								<div class="col-md-12">
									<h4 class="mb-none">Subway 자주묻는 질문입니다.</h4><br>
									<p class="mb-none">
										인터넷 주문 상담전화<br>
										<strong>080 - 500 - 5588</strong><br>
										상담시간 | AM 10:00 ~ PM 10:00<br>
										<br>
										전화상담 전, 주문방법과 자주 묻는 질문을 먼저 확인해보세요!
									</p>
								</div>
							</div>
						</div>
												...
												<div class="toggle toggle-primary" data-plugin-toggle data-plugin-options="{ 'isAccordion': true }">
													...
													<section class="toggle">
														...
														<div class="toggle-content">
															...
															<p><a class="btn btn-primary mb-xl" href="#">멤버십 회원 혜택 보기</a></p>
														</div>
													</section>
													...
													<section class="toggle">
														...
														<div class="toggle-content">
															<p>
																네 정확한 배달 및 포장을 위해 홈페이지 가입 시 본인인증을 실시합니다.<br>
																비회원 주문 시에는 휴대폰 번호인증이 있어야 주문이 가능합니다.
															</p>
														</div>
													</section>
													...
													<section class="toggle">
														...
														<div class="toggle-content">
															<p>
																마이 페이지 > 주문내역을 통해 확인하실 수 있습니다. <br>
																<a class="btn btn-primary mb-xl" href="#">주문내역 바로가기</a>
															</p>
															<p>
																** 단, 비회원 주문을 이용하셨을 경우 주문내역에서 확인되지 않으니<br>
																온라인 고객만족팀 080-500-5588 로 문의 주시기 바랍니다.
															</p>
														</div>
													</section>
													...
													<section class="toggle">
														...
														<div class="toggle-content">
															<p>
																주문/결제하기 페이지에서 4.할인적용의 쿠폰버튼을 클릭하여<br>
																하단의 포인트 적용 입력란에 할인하고자 하는 포인트 액수를 입력하여 적용합니다.
															</p>
														</div>
													</section>
													...
													<section class="toggle">
														...
														<div class="toggle-content">
															<p>
																푸디오더 결제는 신용카드, 체크카드, 휴대폰 소액결제, 네이버페이, 카카오페이와 같은 간편결제가 가능합니다.
															</p>
														</div>
													</section>
													...
													<section class="toggle">
														...
														<div class="toggle-content">
															<p>
																결제수단의 변경은 상담원을 통해 변경 가능합니다.<br>
																단, 주문완료 후 포인트 및 할인적용을 위해 결제수단 변경을 요청 하실 경우 주문내역에 따라 불가할 수 있습니다.<br>

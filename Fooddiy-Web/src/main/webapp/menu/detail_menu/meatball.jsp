		...
		<div class="row">
				...
				<!-- <div class="owl-carousel owl-theme"	data-plugin-options="{'items': 1}"> -->
					<div>
						<div class="thumbnail" style="margin-top: 90px; margin-bottom: 90px">
							<img alt="" class="img-responsive img-rounded" src="${ pageContext.request.contextPath }/resources/img/menu_detail/meatball_marinara.jpg">
						</div>
					</div>
				<!-- </div> -->
			</div>
			...
			<div class="col-md-6">
				<div class="summary entry-summary">
					...
					<p class="price">
						<span class="amount">4,900원</span>
					</p>

					<p class="taller">
						이탈리안 스타일 미트볼에 써브웨이만의 비법이 담긴 마리나라 소스를 듬뿍 얹었습니다.
					</p>
					<p class="inch">

		...
		<div class="row">
				...
				<!-- <div class="owl-carousel owl-theme"	data-plugin-options="{'items': 1}"> -->
					<div>
						<div class="thumbnail" style="margin-top: 90px; margin-bottom: 90px">
							<img alt="" class="img-responsive img-rounded" src="${ pageContext.request.contextPath }/resources/img/menu_detail/chicken_bacon_ranch.jpg">
						</div>
					</div>
				<!-- </div> -->
			</div>
			...
			<div class="col-md-6">
				<div class="summary entry-summary">
					<h1 class="mb-none">
						<strong>치킨 베이컨랜치</strong>
					</h1>
					<div>치킨 스트립 1스쿱, 베이컨 2장, 치즈 2장</div>
					...
					<p class="taller">
						갓 구운 빵에 오븐에서 구워낸 치킨과 신선한 야채와 소스를 선택하여 곁들여 즐길 수 있습니다.
						너무 맛있어서 홀딱 빠져듭니다.
					</p>
					<p class="inch">

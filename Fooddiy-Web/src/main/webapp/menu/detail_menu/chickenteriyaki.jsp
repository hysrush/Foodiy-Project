		...
		<div class="row">
				...
				<!-- <div class="owl-carousel owl-theme"	data-plugin-options="{'items': 1}"> -->
					<div>
						<div class="thumbnail" style="margin-top: 90px; margin-bottom: 90px">
							<img alt="" class="img-responsive img-rounded" src="${ pageContext.request.contextPath }/resources/img/menu_detail/Sweet_Onion_Chicken_Teriyaki.jpg">
						</div>
					</div>
				<!-- </div> -->
			</div>
			...
			<div class="col-md-6">
				<div class="summary entry-summary">
					...
					<p class="taller">
						치킨 데리야끼는 한국인의 입맛을 사로잡았습니다. 풍부한 치킨 스트립에 부드러운 데리야끼 소스를 얹고,
						써브웨이만의 스위트 어니언 소스를 곁들여 구운 저지방 메뉴입니다.
					</p>
					<p class="inch">

	...
	<div class="body">
		...
		<div class="col-md-12">
			<div role="main" class="main">
				...
				<div class="col-md-12">
					<div class="col-md-12"  style="border-style: solid; border-width: 2px">
						<div role="main" class="main" style="border-style: solid; border-width: 2px">
							<div class="container" style="border-style: solid; border-width: 2px">
								<div class="row" style="border-style: solid; border-width: 2px">
									...
									<div class="col-md-9" style="border-style: solid; border-width: 2px">
										<div role="main" class="main shop" style="display: inline;">
													...
													<div class="masonry-loader masonry-loader-showing">
														<ul class="products product-thumb-info-list" id="breadSelect" data-plugin-masonry >
															<li class="col-md-3 col-sm-6 col-xs-12 product"><span
																class="product-thumb-info"> <a href="#"
																	class="add-to-cart-product"> <span> 선택하기</span>
																</a> <span class="product-thumb-info-image"> <span
																		class="product-thumb-info-act"> <span
																			class="product-thumb-info-act-left"><em>Select</em></span>
																			<span class="product-thumb-info-act-right"></span>
																	</span> <img alt="" class="img-responsive"
																		src="${ pageContext.request.contextPath }/resources/img/products/위트.jpg">
																</span> <span class="product-thumb-info-content">
